...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.2\textwidth]{logo-jhipster}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.3\textwidth]{logo-javaee}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.4\textwidth]{logo-spring}
    \caption{Logo Spring}
    \label{fig:figure4}
    \end{center}
\end{figure}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.5\textwidth]{logo-hibernate}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.25\textwidth]{logo-rest}
    \caption{Logo REST}
    \label{fig:figure6}
    \end{center}
\end{figure}
...
\subsection{Oracle}
Oracle database è un \gls{dbmsg} di tipo relazionale prodotto da \href{https://www.oracle.com/}{Oracle corporation}. I database oracle sono noti per offrire performance, scalabilità, affidabilità e sicurezza oltre a poter essere utilizzati sia on premise che nel cloud.
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.29\textwidth]{logo-oracle}
    \caption{Logo Oracle}
    \label{fig:figure7}
    \end{center}
\end{figure}
...
Liquibase è una libreria open source indipendente dal \gls{dbmsg} utilizzato. Viene utilizzato per tracciare, gestire e applicare le modifiche allo schema del database.
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.3\textwidth]{logo-liquibase}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.3\textwidth]{logo-angular}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.45\textwidth]{logo-eclipse}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.4\textwidth]{logo-maven}
    \caption{Logo Maven}
    \label{fig:figure11}
    \end{center}
\end{figure}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.24\textwidth]{logo-git}
    \caption{Logo Git}
    \label{fig:figure12}
    \end{center}
\end{figure}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.23\textwidth]{logo-sqldeveloper}
