...
\input{capitoli/capitolo-2}             % obbiettivi
\input{capitoli/capitolo-3}             % metodo di lavoro
\input{capitoli/capitolo-4}             % prodotto sw
\input{capitoli/capitolo-5}             % docs e test
